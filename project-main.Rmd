...
win <- 60 
lambda_grid <- exp(seq(log(1e-4), log(1), length.out = 20))
...
cvfit <- cv.glmnet(x = X_all, y = y_all, alpha = 0, family = "gaussian", intercept = TRUE, standardize = TRUE, nfolds = 5)
